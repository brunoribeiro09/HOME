...
if(isset($_POST['nome']) and isset($_POST['senha'])) {
    ...
    if($quantidade == 1) {
        ...
        header("Location: https://www.youtube.com/watch?v=Cb0iyx_MQPM&ab_channel=R19Clips");
    }
}
?>
            ...
            <section class="partesuperior"> <!--PARTE DO DISPLAY - CIMA E EM BAIXO-->
                ...
                <section class="area-login">
                    <div class="login">
                        ...
                        <p>Ainda não tem uma conta ? <a href="formulario.php" target="_blank">CRIAR CONTA</a></p>
                    </div>
                </section>
                <picture>
